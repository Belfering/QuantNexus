// src/components/Forge/ForgeModelTab.tsx
// Forge Model subtab component - independent copy of Model tab for Forge context
// Uses 'Forge' tree sync context to maintain independence from main Model tab
...
export interface ForgeModelTabProps {
