...
// Engine choice for backtest execution
export type BacktestEngine = 'node' | 'rust'
...
interface BacktestState {
  ...
  setBacktestEngine: (engine: BacktestEngine) => void
...
export const useBacktestStore = create<BacktestState>()((set) => ({
  ...
  setBacktestEngine: (backtestEngine) => set({ backtestEngine }),
