      ...
      <CardHeader>
        <div className="grid grid-cols-[1fr_1fr_1fr] gap-3 items-stretch">
          ...
          <div className="flex flex-nowrap gap-2 items-stretch">
            ...
            <div className="flex-1 flex flex-col items-center justify-center border border-border rounded px-3">
              <span className="text-xs font-bold text-muted">Engine</span>
              <div className="flex gap-1">
                <button
                  className="px-2 py-0.5 border rounded text-xs font-semibold transition-colors"
                  style={engine === 'js'
                  ...
                  title="Pure JavaScript indicators (no Rust)"
                >
                  JS
                </button>
                <button
                ...
                <button
                  ...
                  title="Full Rust backtest engine"
                >
                  Rust
                </button>
              </div>
